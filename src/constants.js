...
export const MOST_RELEVANT_SECTION_TITLE_TARGET = '#title';
export const MOST_RELEVANT_SECTION_TARGET = 'ytd-rich-section-renderer';
...
export const WAIT_FOR_MOST_RELEVANT_SECTION_INTERVAL_MS = 200;
